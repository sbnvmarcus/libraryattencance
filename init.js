...
<body onload="show()">
    <div id="tabs">
        ...
        <div id="patronIDSection">
            <br><label>Class & Class No. (1E27): </label><input type="text" id="patronID">
        </div>
        <div id="otherIDSection">
            <br><label>Student Number (21290): </label><input type="text" id="otherID">
        </div>
    </div>
    <div>
    ...
    <div id="modal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><a href="https://docs.google.com/spreadsheets/d/1rnrQseMe_4ef0xKMU5uNq_-9MxRJwQLIQwSNlx2-jY0/edit" class="popup-content" target="_blank">瀏覽整個Google Sheets</a></p>
                <p><a href="https://docs.google.com/spreadsheets/d/e/2PACX-1vTbqBNZZOlY47IiTNjS7Ie4zK5uqQFI-onHH6lHHORm78U1Q5LHZqa7aOJEO8lJVGLNz899ZAh4b7Lq/pubhtml" class="popup-content" target="_blank">瀏覽整個網站紀錄</a></p>
            </div>
    ...
    <form id="myForm">
        <h3><span class="header">最新輸入資料（包括登錄在 <a href="https://docs.google.com/spreadsheets/d/1rnrQseMe_4ef0xKMU5uNq_-9MxRJwQLIQwSNlx2-jY0/edit" target="_blank" style="color:lightgreen;text-decoration:none"><img src="view.png" width="15px"> Google Sheets</a> ）</span></h3>
        ...
        <label>時段：</label><br>
        <input type="radio" id="first" name="period" value="first" readonly> 1st Recess<br>
        <input type="radio" id="second" name="period" value="second" readonly> 2nd Recess
    </form>
    <br><br>
